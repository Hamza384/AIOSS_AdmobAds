...
public class MyShortcodeMedia implements Serializable {

    @SerializedName("display_url")
    private String display_url;

    @SerializedName("display_resources")
    private List<MyDisplayResource> display_resources;
    ...
    public List<MyDisplayResource> getDisplay_resources() {
        return display_resources;
    }

    public void setDisplay_resources(List<MyDisplayResource> display_resources) {
