...
public class Utils {
    ...
    public static final String CHANNEL_ID = "ass_channel";
    public static final String CHANNEL_NAME = "StatusSaver";
    public static final String CHANNEL_DESCRIPTION = "StatusSaver";
    ...
    //alarm
    public static String NotifMessage = "Download your favourite status with just one click";
    public static String NotifTitle = "All Status Saver";
    public static int Alarm_Id = 2020;
    public static int Notif_Id = 1313;
    ...
    public static void setAlarmEveryDay(Context context) {
        ...
        PendingIntent pendingIntent = PendingIntent.getBroadcast(context, Utils.Alarm_Id, intent, PendingIntent.FLAG_UPDATE_CURRENT);
