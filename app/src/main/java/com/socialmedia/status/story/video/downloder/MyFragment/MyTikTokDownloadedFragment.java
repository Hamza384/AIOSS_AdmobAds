...
import static com.socialmedia.status.story.video.downloder.MyUtils.Utils.RootDirectoryTikTokShow;

public class MyTikTokDownloadedFragment extends Fragment implements FileListClickInterface {
    ...
    public static MyTikTokDownloadedFragment newInstance(String param1) {
        MyTikTokDownloadedFragment fragment = new MyTikTokDownloadedFragment();
    ...
    private void getAllFiles(){
        ...
        if (files!=null) {
            ...
            myFileListAdapter = new MyFileListAdapter(myGalleryActivity, fileArrayList, MyTikTokDownloadedFragment.this);
