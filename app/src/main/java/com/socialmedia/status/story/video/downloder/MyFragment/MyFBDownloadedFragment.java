...
import static com.socialmedia.status.story.video.downloder.MyUtils.Utils.RootDirectoryFacebookShow;

public class MyFBDownloadedFragment extends Fragment implements FileListClickInterface {
    ...
    public static MyFBDownloadedFragment newInstance(String param1) {
        MyFBDownloadedFragment fragment = new MyFBDownloadedFragment();
    ...
    private void getAllFiles(){
        ...
        if (files!=null) {
            ...
            myFileListAdapter = new MyFileListAdapter(myGalleryActivity, fileArrayList, MyFBDownloadedFragment.this);
