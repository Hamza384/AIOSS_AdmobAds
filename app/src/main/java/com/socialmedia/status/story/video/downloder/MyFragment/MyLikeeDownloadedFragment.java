...
public class MyLikeeDownloadedFragment extends Fragment implements FileListClickInterface {
    ...
    public static MyLikeeDownloadedFragment newInstance(String param1) {
        MyLikeeDownloadedFragment fragment = new MyLikeeDownloadedFragment();
    ...
    private void getAllFiles(){
        ...
        if (files!=null) {
            ...
            myFileListAdapter = new MyFileListAdapter(myGalleryActivity, fileArrayList, MyLikeeDownloadedFragment.this);
