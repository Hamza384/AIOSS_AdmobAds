...
public class WhatsappStatusAdapter extends RecyclerView.Adapter<WhatsappStatusAdapter.ViewHolder> {
    ...
    private ArrayList<MyWhatsappStatusModel> fileArrayList;
    private LayoutInflater layoutInflater;
    public String SaveFilePath = RootDirectoryWhatsappShow+ "/";
    public WhatsappStatusAdapter(Context mContext, ArrayList<MyWhatsappStatusModel> files) {
    ...
    public void onBindViewHolder(@NonNull WhatsappStatusAdapter.ViewHolder viewHolder, int i) {
        MyWhatsappStatusModel fileItem = fileArrayList.get(i);
        ...
        viewHolder.itemsWhatsappViewBinding.tvDownload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                MediaScannerConnection.scanFile(mContext, new String[]{newFile.getAbsolutePath()}, new String[]{ContentType},
                ...
                Toast.makeText(mContext, mContext.getResources().getString(R.string.saved_to) + SaveFilePath + fileNameChange, Toast.LENGTH_LONG).show();
            }
        });
    }
    @Override
