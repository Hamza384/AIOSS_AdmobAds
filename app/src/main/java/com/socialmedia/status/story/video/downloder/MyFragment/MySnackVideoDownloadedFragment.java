...
import static com.socialmedia.status.story.video.downloder.MyUtils.Utils.RootDirectorySnackVideoShow;

public class MySnackVideoDownloadedFragment extends Fragment implements FileListClickInterface {
    ...
    public static MySnackVideoDownloadedFragment newInstance(String param1) {
        MySnackVideoDownloadedFragment fragment = new MySnackVideoDownloadedFragment();
    ...
    private void getAllFiles(){
        ...
        if (files!=null) {
            ...
            myFileListAdapter = new MyFileListAdapter(myGalleryActivity, fileArrayList, MySnackVideoDownloadedFragment.this);
