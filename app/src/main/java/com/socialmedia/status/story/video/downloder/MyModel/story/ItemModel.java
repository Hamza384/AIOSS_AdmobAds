...
public class ItemModel implements Serializable {
    ...
    private ArrayList<MyVideoVersionModel> video_versions;
    ...
    public ArrayList<MyVideoVersionModel> getVideo_versions() {
        return video_versions;
    }

    public void setVideo_versions(ArrayList<MyVideoVersionModel> video_versions) {
