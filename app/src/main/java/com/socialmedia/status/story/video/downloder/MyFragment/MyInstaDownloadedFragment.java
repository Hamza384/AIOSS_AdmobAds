...
import static com.socialmedia.status.story.video.downloder.MyUtils.Utils.RootDirectoryInstaShow;

public class MyInstaDownloadedFragment extends Fragment implements FileListClickInterface {
    ...
    public static MyInstaDownloadedFragment newInstance(String param1) {
        MyInstaDownloadedFragment fragment = new MyInstaDownloadedFragment();
    ...
    private void getAllFiles(){
        ...
        if (files!=null) {
            ...
            myFileListAdapter = new MyFileListAdapter(myGalleryActivity, fileArrayList, MyInstaDownloadedFragment.this);
