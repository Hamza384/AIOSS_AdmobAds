...
import static com.socialmedia.status.story.video.downloder.MyUtils.Utils.RootDirectoryTwitterShow;

public class MyTwitterDownloadedFragment extends Fragment implements FileListClickInterface {
    ...
    public static MyTwitterDownloadedFragment newInstance(String param1) {
        MyTwitterDownloadedFragment fragment = new MyTwitterDownloadedFragment();
    ...
    private void getAllFiles(){
        ...
        if (files!=null) {
            ...
            myFileListAdapter = new MyFileListAdapter(myGalleryActivity, fileArrayList, MyTwitterDownloadedFragment.this);
