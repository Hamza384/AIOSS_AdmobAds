...
import static com.socialmedia.status.story.video.downloder.MyUtils.Utils.RootDirectoryRoposoShow;

public class MyRoposoDownloadedFragment extends Fragment implements FileListClickInterface {
    ...
    public static MyRoposoDownloadedFragment newInstance(String param1) {
        MyRoposoDownloadedFragment fragment = new MyRoposoDownloadedFragment();
    ...
    private void getAllFiles(){
        ...
        if (files!=null) {
            ...
            myFileListAdapter = new MyFileListAdapter(myGalleryActivity, fileArrayList, MyRoposoDownloadedFragment.this);
