...
import static com.socialmedia.status.story.video.downloder.MyUtils.Utils.RootDirectoryShareChatShow;

public class MySharechatDownloadedFragment extends Fragment implements FileListClickInterface {
    ...
    public static MySharechatDownloadedFragment newInstance(String param1) {
        MySharechatDownloadedFragment fragment = new MySharechatDownloadedFragment();
    ...
    private void getAllFiles(){
        ...
        if (files!=null) {
            ...
            myFileListAdapter = new MyFileListAdapter(myGalleryActivity, fileArrayList, MySharechatDownloadedFragment.this);
